  ...
  const renderMenuItems = (
    ...
    <ul className="flex flex-col gap-4">
      {navItems.map((nav, index) => {
        let dataTour = "";
        if (nav.name === "Dashboard") dataTour = "dashboard-menu";
        else if (nav.name === "Product Catalog") dataTour = "product-menu";
        else if (nav.name === "Lifecycle Analyst") dataTour = "lifecycle-menu";
